...
namespace Proiect {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UtilizatoriDataTable : global::System.Data.TypedTableBase<UtilizatoriRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UtilizatoriRow AddUtilizatoriRow(string Nume, int Varsta, long CNP) {
        ...
        public partial class UtilizatoriRow : global::System.Data.DataRow {
            ...
            public long CNP {
                get {
                    try {
                        return ((long)(this[this.tableUtilizatori.CNPColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Proiect.DatabaseDataSetTableAdapters {
    ...
    public partial class UtilizatoriTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Utilizatori] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Varsta = 1 AND [Varsta] IS NULL) OR ([Varsta] = @Original_Varsta)) AND ((@IsNull_CNP = 1 AND [CNP] IS NULL) OR ([CNP] = @Original_CNP)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Utilizatori] ([Id], [Nume], [Varsta], [CNP]) VALUES (@Id, @Num" +
                "e, @Varsta, @CNP);\r\nSELECT Id, Nume, Varsta, CNP FROM Utilizatori WHERE (Id = @I" +
                "d)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Utilizatori] SET [Id] = @Id, [Nume] = @Nume, [Varsta] = @Varsta, [CNP] = @CNP WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Varsta = 1 AND [Varsta] IS NULL) OR ([Varsta] = @Original_Varsta)) AND ((@IsNull_CNP = 1 AND [CNP] IS NULL) OR ([CNP] = @Original_CNP)));
SELECT Id, Nume, Varsta, CNP FROM Utilizatori WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Proiect.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nume, Varsta, CNP FROM dbo.Utilizatori";
        ...
        public virtual int Delete(int Original_Id, string Original_Nume, global::System.Nullable<int> Original_Varsta, global::System.Nullable<int> Original_CNP) {
        ...
        public virtual int Insert(int Id, string Nume, global::System.Nullable<int> Varsta, global::System.Nullable<int> CNP) {
            ...
            if ((CNP.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(CNP.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string Nume, global::System.Nullable<int> Varsta, global::System.Nullable<int> CNP, int Original_Id, string Original_Nume, global::System.Nullable<int> Original_Varsta, global::System.Nullable<int> Original_CNP) {
            ...
            if ((CNP.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(CNP.Value));
            }
            else {
            ...
            if ((Original_Varsta.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Varsta.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, global::System.Nullable<int> Varsta, global::System.Nullable<int> CNP, int Original_Id, string Original_Nume, global::System.Nullable<int> Original_Varsta, global::System.Nullable<int> Original_CNP) {
            return this.Update(Original_Id, Nume, Varsta, CNP, Original_Id, Original_Nume, Original_Varsta, Original_CNP);
        }
    }
